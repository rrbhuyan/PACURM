...
-----------------------------------------------------
Description of files in the Code folder
-----------------------------------------------------

- CURM1_data_clean.r and CURM2_data_clean:
...
and output the following files (saved to the Data folder) required to perform CURM:
